...
#ifndef EVENT_SYSTEM_MOUSE_EVENTS_HH
#define EVENT_SYSTEM_MOUSE_EVENTS_HH
...
namespace Mikoto {
    ...
    public:
        explicit MouseButtonPressedEvent(Int32_T button, Int32_T modifiers = 0)
            :   MouseEvent{ GetStaticType(), GetCategoryFromType(GetStaticType()) }, m_Button{ button }, m_Modifiers{ modifiers }
        {}
    ...
    public:
        explicit MouseButtonReleasedEvent(Int32_T button)
            :    MouseEvent{ GetStaticType(), GetCategoryFromType(GetStaticType()) }, m_Button{ button }
        {}
    ...
    public:
        MouseScrollEvent(double xOffset, double yOffset)
            :   MouseEvent{ GetStaticType() }, m_OffsetX{ xOffset }, m_OffsetY{ yOffset }
        {}
...
#endif // EVENT_SYSTEM_MOUSE_EVENTS_HH
